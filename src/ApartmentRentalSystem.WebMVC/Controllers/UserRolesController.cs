...
namespace ApartmentRentalSystem.WebMVC.Controllers
{
    public class UserRolesController : Controller
    {
        ...
        public UserRolesController(ApartmentContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Type,Name,Id")] UserRole userRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Type,Name,Id")] UserRole userRole)
        {
            if (id != userRole.Id)
            {
                return NotFound();
