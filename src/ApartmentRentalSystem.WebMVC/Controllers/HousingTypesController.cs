...
namespace ApartmentRentalSystem.WebMVC.Controllers
{
    public class HousingTypesController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            return RedirectToAction("Index", "Apartments", new { housingTypeId = id });
        }
        ...
        public async Task<IActionResult> Create([Bind("Name,Id")] HousingType housingType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Id")] HousingType housingType)
        {
